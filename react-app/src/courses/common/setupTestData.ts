...
// Fixture copied from ../../../../server/db-data.ts (COURSES); mirrors src/app/courses/common/setup-test-data.ts
export const COURSES: Record<number, Partial<Course> & { url?: string }> = {
